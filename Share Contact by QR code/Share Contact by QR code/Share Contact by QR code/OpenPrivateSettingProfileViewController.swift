...
//            }
    ...
    @IBAction func doneButtonPressed(_ sender: Any) {
        ...
        let privateFirstName = Database.database().reference().child("Users").child(userID!).child("Private").child("First Name")
        ...
        let privateLastName = Database.database().reference().child("Users").child(userID!).child("Private").child("Last Name")
        ...
        let privateCompany = Database.database().reference().child("Users").child(userID!).child("Private").child("Company")
        ...
        let privatePhoneNumber = Database.database().reference().child("Users").child(userID!).child("Private").child("Phone Number")
        ...
        let privateEmail = Database.database().reference().child("Users").child(userID!).child("Private").child("Email")
        ...
        let privateUrl = Database.database().reference().child("Users").child(userID!).child("Private").child("URL")
        ...
        {
            print(address)
            //let privateFirstName = Database.database().reference().child("Users").child(userID!).child("Private").child("Address")
       ...
       // print((dict["Address"]!!))
        ...
        {
            print(birthday)
            //let privateFirstName = Database.database().reference().child("Users").child(userID!).child("Private").child("Birthday")
      ...
      //  print(dict["Birthday"]!!)
        ...
        let privateSocialProfiles = Database.database().reference().child("Users").child(userID!).child("Private").child("Social Profile")
        ...
        let privateAccount = Database.database().reference().child("Users").child(userID!).child("Private").child("Instant Message")
        ...
        let privateRelatives = Database.database().reference().child("Users").child(userID!).child("Private").child("Relatives")
        ...
        let privateNotes = Database.database().reference().child("Users").child(userID!).child("Private").child("Notes")
