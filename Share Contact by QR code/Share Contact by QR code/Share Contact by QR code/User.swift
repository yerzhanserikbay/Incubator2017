...
//
//  Created by YERZHAN SERIKBAY on 7/25/17.
...
//        
//        let firstNameRef = Database.database().reference().child("Users").child(userID!).child("Private").child("First Name")
//        
...
//        })
//        
//        let lastNameRef = Database.database().reference().child("Users").child(userID!).child("Private").child("Last Name")
...
//        })
//        
//        let companyRef = Database.database().reference().child("Users").child(userID!).child("Private").child("Company")
...
//        })
//        
//        let phoneNumberRef = Database.database().reference().child("Users").child(userID!).child("Private").child("Phone Number")
...
//        })
//        
//        let emailRef = Database.database().reference().child("Users").child(userID!).child("Private").child("Email")
...
//        })
//        
//        let urlRef = Database.database().reference().child("Users").child(userID!).child("Private").child("URL")
...
//        })
//        
//        //   let addressRef = Database.database().reference().child("Users").child(userID!).child("Private").child("Address")
...
//        //})
//        
//        //let birthdayRef = Database.database().reference().child("Users").child(userID!).child("Private").child("Birthday")
...
//        // })
//        
//        let socialProfileRef = Database.database().reference().child("Users").child(userID!).child("Private").child("Social Profile")
...
//        })
//        
//        let instantMessageRef = Database.database().reference().child("Users").child(userID!).child("Private").child("Instant Message")
...
//        })
//        
//        let relativesRef = Database.database().reference().child("Users").child(userID!).child("Private").child("Relatives")
...
//        })
//        
//        let notesRef = Database.database().reference().child("Users").child(userID!).child("Private").child("Notes")
