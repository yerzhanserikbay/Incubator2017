//
//  OpenPublicSettingProfileViewController.swift
...
class OpenPublicSettingProfileViewController: FormViewController {
    ...
    @IBAction func doneButtonPressed(_ sender: Any) {
        ...
        let privateFirstName = Database.database().reference().child("Users").child(userID!).child("Public").child("First Name")
        ...
        let privateLastName = Database.database().reference().child("Users").child(userID!).child("Public").child("Last Name")
        ...
        let privateCompany = Database.database().reference().child("Users").child(userID!).child("Public").child("Company")
        ...
        let privatePhoneNumber = Database.database().reference().child("Users").child(userID!).child("Public").child("Phone Number")
        ...
        let privateEmail = Database.database().reference().child("Users").child(userID!).child("Public").child("Email")
        ...
        let privateUrl = Database.database().reference().child("Users").child(userID!).child("Public").child("URL")
        ...
        {
            print(address)
            //let privateFirstName = Database.database().reference().child("Users").child(userID!).child("Public").child("Address")
        ...
        {
            print(birthday)
            //let privateFirstName = Database.database().reference().child("Users").child(userID!).child("Public").child("Birthday")
        ...
        let privateSocialProfiles = Database.database().reference().child("Users").child(userID!).child("Public").child("Social Profile")
        ...
        let privateAccount = Database.database().reference().child("Users").child(userID!).child("Public").child("Instant Message")
        ...
        let privateRelatives = Database.database().reference().child("Users").child(userID!).child("Public").child("Relatives")
        ...
        let privateNotes = Database.database().reference().child("Users").child(userID!).child("Public").child("Notes")
